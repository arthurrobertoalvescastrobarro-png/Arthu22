...
{
    titulo: "Black Clover",
    imagem: "https://media.themoviedb.org/t/p/w300_and_h450_face/kaMisKeOoTBPxPkbC3OW7Wgt6ON.jpg",
    ...
    classificacao: "14",
    categoria: ["Ação", "Fantasia", "Aventura"],
    link: "https://animesonline.io/anime/black-clover-dublado/",
    tipo: "Anime",
    
},
{
    titulo: "Fire Force",
    imagem: "https://media.themoviedb.org/t/p/w300_and_h450_face/96jrp8XIEPKC7xHhbkpWLD15oYW.jpg",
    descricao: "Shinra e seus companheiros estão prontos para entrar para a Brigada de Incêndio para impedir que os demônios flamejantes, chamados de Infernais, incendeiem toda a cidade!",
    temporadas: "3-Temporadas",
    classificacao: "16",
    categoria: ["Ação", "Fantasia", "Drama"],
    link: "https://animesonline.io/?s=Fire+Force",
    tipo: "Anime",
    
},
{
    titulo: "Dr. Stone",
    imagem: "https://media.themoviedb.org/t/p/w300_and_h450_face/xEbnuDJXA0MYVV1zjizGWgOhSPE.jpg",
    descricao: "Ao acordar em um mundo onde a humanidade foi transformada em pedra, Senku, um gênio da ciência, e seu amigo Taiju usam suas habilidades para reconstruir a civilização.",
    temporadas: "4-Temporadas",
    classificacao: "12",
    categoria: ["Aventura", "Ficção Científica", "Comédia"],
    link: "https://animesonline.io/?s=Dr.%20Stone",
    tipo: "Anime",
    
},
{
    titulo: "Kaiju No. 8",
    imagem: "https://media.themoviedb.org/t/p/w300_and_h450_face/bJxGs0w5RAhaX4fIUQu511rvm0S.jpg",
    descricao: "Em um mundo assolado por criaturas ameaçadoras conhecidas como Kaiju, Kafka Hibino sempre sonhou em se alistar na Força de Defesa do Japão para derrotá-los. Kafka prometeu à sua amiga de infância, Mina Ashiro, que eles derrotariam esses monstros juntos. Com o tempo, circunstâncias da vida os forçaram a seguir caminhos diferentes, fazendo com que Kafka abandonasse sua ambição. Ele conseguiu um emprego na Monster Sweeper, Inc., uma empresa de limpeza profissional especializada em lidar com as consequências das batalhas contra Kaiju. Por outro lado, Mina Ashiro agora é a capitã da 3ª Divisão da Força de Defesa. No momento, ele não é considerado digno de lutar contra os Kaiju ao lado dela. No trabalho, Kafka acaba conhecendo o altamente motivado Reno Ichikawa. A determinação incansável de Reno de se juntar à Força de Defesa não deixa espaço para o fracasso. Sua perseverança reacende a ambição de Kafka de estar ao lado de Mina enquanto protegem a humanidade dos Kaiju juntos!",
    temporadas: "1-Temporada",
    classificacao: "16",
    categoria: ["Ação", "Ficção Científica", "Fantasia"],
    link: "https://animesonline.io/anime/kaijuu-8-gou-2-dublado/",
    tipo: "Anime",
    
},
{
    titulo: "Frieren e a Jornada para o Além",
    imagem: "https://media.themoviedb.org/t/p/w300_and_h450_face/d9IuDqPWoUYukwblQhqV00jlCzZ.jpg",
    descricao: "Após derrotar o Rei Demônio, a elfa Frieren inicia uma jornada para compreender os sentimentos humanos.",
    temporadas: "1-Temporada",
    classificacao: "14",
    categoria: ["Fantasia", "Drama", "Aventura"],
    link: "https://netcinewy.lat/tvshows/frieren-e-a-jornada-para-o-alem-segunda-temporada/",
    tipo: "Anime",
    
},
{
    titulo: "Hell's Paradise",
    imagem: "https://media.themoviedb.org/t/p/w300_and_h450_face/1V9I7SvZbYoMbSvdtnlkkq9SB1k.jpg",
    ...
    classificacao: "18",
    categoria: ["Ação", "Fantasia", "Terror"],
    link: "https://animesonline.io/?s=Hell%27s%20Paradise",
    tipo: "Anime",
    
},
{
    titulo: "The Misfit of Demon King Academy",
    imagem: "https://media.themoviedb.org/t/p/w300_and_h450_face/xBNR7V4s5b0qQfRCiyEvIC5PS6v.jpg",
    ...
    classificacao: "14",
    categoria: ["Fantasia", "Ação", "Comédia"],
    link: "https://animesonline.io/?s=The%20Misfit%20of%20Demon%20King%20Academy",
    tipo: "Anime",
    
},
{
    titulo: "That Time I Got Reincarnated as a Slime",
    imagem: "https://media.themoviedb.org/t/p/w300_and_h450_face/pzujcdPAoH361NObVrtbA7zACE7.jpg",
    ...
    classificacao: "14",
    categoria: ["Fantasia", "Aventura", "Comédia"],
    link: "https://animesonline.io/?s=That%20Time%20I%20Got%20Reincarnated%20as%20a%20Slime",
    tipo: "Anime",
    
},
{
    titulo: "Overlord",
    imagem: "https://media.themoviedb.org/t/p/w300_and_h450_face/K8ZUjxaj9F0t3AwJDz8ypzBynM.jpg",
    ...
    classificacao: "16",
    categoria: ["Fantasia", "Ação", "Aventura"],
    link: "https://animesonline.io/?s=Overlord+dublado",
    tipo: "Anime",
    
},
{
    titulo: "No Game No Life",
    imagem: "https://media.themoviedb.org/t/p/w300_and_h450_face/7l8nKzWZrhlGAWUubbw4UJaRlLH.jpg",
    descricao: "Os lendários irmãos gamers Sora e Shiro são transportados para um mundo onde tudo é resolvido com jogos, e a humanidade está em grave perigo de extinção.",
    temporadas: "1-Temporada",
    classificacao: "16",
    categoria: ["Fantasia", "Comédia", "Aventura"],
    link: "https://animesonline.io/?s=No%20Game%20No%20Life",
    tipo: "Anime",
    
},
{
    titulo: "Classroom of the Elite",
    imagem: "https://media.themoviedb.org/t/p/w300_and_h450_face/yuHanbUUIv2UWRxxQFt9n8jtmOJ.jpg",
    descricao: "Kiyotaka Ayanokouji se matricula na prestigiosa Academia Tokyo Koudo Ikusei, mas é designado para a Classe 1-D, onde ficam os alunos com problemas de comportamento. A escola concede pontos equivalentes a 100.000 ienes por mês e permite uma liberdade incomum nas aulas, mascarando um sistema mais complexo.",
    temporadas: "4-Temporadas",
    classificacao: "16",
    categoria: ["Drama", "Mistério", "Suspense"],
    link: "https://animesonline.io/?s=Classroom%20of%20the%20Elite",
    tipo: "Anime",
    
},
{
    titulo: "Blue Exorcist",
    imagem: "https://media.themoviedb.org/t/p/w300_and_h450_face/kpNoqNmElzGUEcEoZyfFwvYXMsR.jpg",
    descricao: "Determinado a se livrar da maldição de ser filho ilegítimo de Satã, Rin segue os passos de seu mentor e se alista na Academia Vera Cruz para se tornar exorcista.",
    temporadas: "5-Temporadas",
    classificacao: "16",
    categoria: ["Ação", "Fantasia", "Drama"],
    link: "https://animesonline.io/?s=Blue%20Exorcist",
    tipo: "Anime",
    
},
{
    titulo: "Mob Psycho 100",
    imagem: "https://media.themoviedb.org/t/p/w300_and_h450_face/vR7hwaGQ0ySRoq1WobiNRaPs4WO.jpg",
    ...
    temporadas: "3-Temporadas",
    classificacao: "14",
    categoria: ["Ação", "Comédia", "Sobrenatural"],
    link: "https://animesonline.io/?s=Mob+Psycho+100",
    tipo: "Anime",
    
},
{
    titulo: "Noragami",
    imagem: "https://media.themoviedb.org/t/p/w300_and_h450_face/7pL2wGmy92v31ceYvCVIg4ilwLr.jpg",
    descricao: "Yato é um deus menor que sonha em ter milhões de seguidores. Infelizmente, seu objetivo está longe de se tornar realidade: ele não tem sequer um santuário dedicado ao seu nome e está sem um Instrumento Divino desde que o último pediu demissão. Justamente nessa fase ruim, Yato conhece uma garota chamada Hiyori e muda a vida dela para sempre.",
    temporadas: "2-Temporadas",
    classificacao: "14",
    categoria: ["Ação", "Fantasia", "Comédia"],
    link: "https://animesonline.io/?s=Noragami",
    tipo: "Anime",
    
},
{
    titulo: "Akame ga Kill!",
    imagem: "https://media.themoviedb.org/t/p/w300_and_h450_face/rMpvMbSlPbm5QYfFem9fx2Jnttq.jpg",
    ...
    classificacao: "18",
    categoria: ["Ação", "Fantasia", "Drama"],
    link: "https://animesonline.io/?s=Akame+ga+Kill%21",
    tipo: "Anime",
    
},
{
    titulo: "SWAT: Força de Intervenção",
    imagem: "https://media.themoviedb.org/t/p/w300_and_h450_face/byFarhK0Wxmf9mSOOR9ZQ31sShJ.jpg",
    descricao: "Dividido entre a corporação e as ruas, o tenente Daniel Harrelson encara a missão de liderar uma unidade do Esquadrão de Armas e Táticas Especiais na comunidade onde cresceu.",
    temporadas: "8-Temporadas",
    classificacao: "16",
    categoria: ["Ação", "Policial", "Drama"],
    link: "https://www.pobreflixtv.living/series/online/swat-forca-de-intervencao-dublado-6640/",
    tipo: "Série",
...
},
{
    ...
    imagem: "https://i2.wp.com/animesonline.io/wp-content/uploads/2026/07/1785427723-8207-156339l.jpg?resize=247,350",
    descricao: "Sasaki é um funcionário sobrecarregado que vive à deriva na rotina corporativa, sustentado pelos cigarros e pelo atendimento alegre e sorridente de Yamada, a balconista de seu supermercado favorito. Mas, certa noite, após um turno exaustivo, ele chega atrasado e não encontra Yamada em lugar algum. Sem ter onde fumar, ele desanima — até que uma jovem com piercings o chama: “Você pode fumar aqui.”",
    temporadas: "1-Temporada",
    classificacao: "14",
    categoria: ["Romance", "Comédia", "Fantasia"],
    link: "https://animesonline.io/?s=Super%20no%20Ura%20de%20Yani%20Suu%20Futari%20",
    tipo: "Anime",
},
{
    titulo: "Masamune-kun's Revenge ",
    imagem: "https://media.themoviedb.org/t/p/w300_and_h450_face/lOkjPZ2EO0K1H0CgRAd8SLBTOav.jpg",
    descricao: "Masamune Makabe, um garoto fraco e gorducho, sofreu uma dura rejeição nas mãos da bela Aki Adagaki. Oito anos depois, após perder bastante peso, ele troca de nome e retorna como um belo rapaz... Tudo para fazer com que Aki, a Princesa Brutal, se apaixone por ele e lhe permita rejeitá-la da maneira cruel como foi rejeitado.",
    temporadas: "2-Temporadas",
    classificacao: "16",
    categoria: ["Romance", "Drama", "Comédia"],
    link: "https://animesonline.io/?s=Masamune-kun%27s%20Revenge",
    tipo: "Anime",
},
{
    titulo: "My Status as an Assassin Obviously Exceeds the Hero's",
    imagem: "https://media.themoviedb.org/t/p/w300_and_h450_face/oQk3aXYEa4TMd9rAYgzDpAYTU8P.jpg",
    descricao: "Akira Oda e seus colegas de escola são transportados para outro mundo! Enquanto os outros alunos ganham habilidades especiais com a ida para o outro mundo, Akira só consegue as habilidades de um “assassino” medíocre. Mas logo ele passa a ser considerado um “herói”, que é a profissão mais forte. Depois que Akira começa a suspeitar do rei que levou eles para esse outro mundo, ele é acusado de um crime que não cometeu e precisa fugir.",
    temporadas: "1-Temporada",
    classificacao: "16",
    categoria: ["Fantasia", "Ação", "Romance"],
    link: "https://animesonline.io/anime/ansatsusha-de-aru-ore-no-status-ga-yuusha-yori-mo-akiraka-ni-tsuyoi-no-da-ga/",
    tipo: "Anime",
},
{
    titulo: "Scooped Up by an S-Rank Adventurer!",
    imagem: "https://media.themoviedb.org/t/p/w300_and_h450_face/6QZie7hNdSvqPSIsZtMiX2CRbYY.jpg",
    descricao: "Lloyd é um mago branco que foi inesperadamente banido do grupo do herói. Como estava perdido e inseguro, ele cruzou por acaso com um grupo de aventureiros de nível S que precisava de um mago branco, e então se juntou a eles em sua missão. Na ocasião, ninguém imaginava que o grupo do herói se desintegraria e que Lloyd alcançaria a fama. Esta é uma história sobre um usuário de magia de suporte incomparável, que acredita ser comum, mas que se torna um aventureiro imparável.",
    temporadas: "1-Temporada",
    classificacao: "14",
    categoria: ["Ação", "Aventura", "Fantasia"],
    link: "https://animesonline.io/anime/yuusha-party-wo-tsuihou-sareta-shiromadoushi-s-rank-boukensha-ni-hirowareru-kono-shiromadoushi-ga-kikakugai-sugiru/",
    tipo: "Anime",
},
{
    titulo: "The Ogre's Bride",
    imagem: "https://media.themoviedb.org/t/p/w300_and_h450_face/oZHzniVRilau9vY7mOe36smC09T.jpg",
    descricao: "Num mundo onde humanos e ayakashi – seres sobrenaturais – coexistem, ser escolhida como noiva de um ayakashi é a maior honra. Yuzu, uma estudante comum, foi ignorada a vida toda, ofuscada pela sombra de sua irmã Karin, uma noiva escolhida. Quando Yuzu já não aguenta mais, ela inesperadamente conquista o coração de Reiya, um ogro galante de um clã poderoso que a reivindica como sua.",
    temporadas: "1-Temporada",
    classificacao: "14",
    categoria: ["Comédia", "Fantasia", "Drama"],
    link: "https://animesonline.io/anime/oni-no-hanayome/",
    tipo: "Anime",
},
{
    titulo: "Medaka Kuroiwa is Impervious to My Charms",
    imagem: "https://media.themoviedb.org/t/p/w300_and_h450_face/8cjNjEYJVqj0nTeuZlMv8IUvI65.jpg",
    descricao: "Para Mona Kawai, ganhar corações e chamar atenções é algo que vem naturalmente. Tudo muda quando Medaka Kuroiwa, um novo aluno, chega ao colégio. Ele não dá a mínima para Mona e vira a vida dela de cabeça para baixo! Mona tenta de tudo para conquistar Medaka, até chegando a extremos.",
    temporadas: "1-Temporada",
    classificacao: "14",
    categoria: ["Comédia", "Fantasia"],
    link: "https://animesonline.io/anime/kuroiwa-medaka-ni-watashi-no-kawaii-ga-tsuujinai/",
    tipo: "Anime",
},
{
    titulo: "Lookism",
    imagem: "https://media.themoviedb.org/t/p/w300_and_h450_face/qkoM63HDuCOSwxGfb0pljrgns9I.jpg",
    descricao: "Em uma sociedade que favorece a beleza, um estudante leva uma vida dupla, alternando entre dois corpos de aparências totalmente opostas.",
    temporadas: "1-Temporada",
    classificacao: "16",
    categoria: ["Fantasia", "Drama"],
    link: "https://animesonline.io/anime/lookism-dublado/",
    tipo: "Anime",
},
{
    titulo: "I'm Getting Married to a Girl I Hate in My Class",
    imagem: "https://media.themoviedb.org/t/p/w300_and_h450_face/k0Yb8KjspVjNlmvHNgqRRbhZ6LA.jpg",
    ...
    temporadas: "1-Temporada",
    classificacao: "14",
    categoria: ["Comédia", "Romance", "Fantasia"],
    link: "https://animesonline.io/anime/class-no-daikirai-na-joshi-to-kekkon-suru-koto-ni-natta/",
    tipo: "Anime",
},
{
    titulo: "Haibara's Teenage New Game+",
    imagem: "https://media.themoviedb.org/t/p/w300_and_h450_face/gle4UrLJK0s8YkkJEb7XUtdnTTy.jpg",
    descricao: "Todos nós temos memórias constrangedoras ou profundos arrependimentos do ensino médio, certo? O universitário Natsuki Haibara, que sofre de ansiedade social, certamente tem. Quando ele pensa naquela época da sua vida, tudo o que ele tem são fantasias fugazes de uma adolescência feliz que poderia ter sido. Imagine então sua perplexidade e surpresa quando ele inexplicavelmente se vê sete anos no passado… um mês antes do seu primeiro ano do ensino médio! Haibara conseguirá evitar seus erros anteriores, chegar ao topo da pirâmide social da escola e ficar com a garota dos seus sonhos? Ou será forçado a reviver três anos de solidão como o cara mais odiado da escola? Ele precisará de toda a ajuda possível para obter sucesso, desde um regime de exercícios físicos até guias online, uma amizade de infância e muita força de vontade. Veja como Haibara dá uma segunda chance à sua adolescência.",
    temporadas: "1-Temporada",
    classificacao: "14",
    categoria: ["Comédia", "Drama", "Fantasia"],
    link: "https://animesonline.io/anime/haibara-kun-no-tsuyokute-seishun-new-game/",
    tipo: "Anime",
},
{
    titulo: "Sword of the Demon Hunter: Kijin Gentosho",
    imagem: "https://media.themoviedb.org/t/p/w300_and_h450_face/8BNGnDKMaDvpmkTd6z9pQL97Upe.jpg",
    ...
    temporadas: "1-Temporada",
    classificacao: "18",
    categoria: ["Ficção Científica", "Drama", "Fantasia"],
    link: "https://animesonline.io/anime/kijin-gentoushou/",
    tipo: "Anime",
},
{
    ...
    temporadas: "1-Temporada",
    classificacao: "18",
    categoria: ["Ação", "Ficção Cietífica", "Drama", "Aventura", "Fantasia", "Crime"],
    link: "https://animesonline.io/anime/kaifuku-jutsushi-no-yarinaoshi/",
    tipo: "Anime",
},
{
    titulo: "Parasyte: The Maxim",
    imagem: "https://media.themoviedb.org/t/p/w300_and_h450_face/cXBfjZSdJelu2r0wKD7qCxS71kb.jpg",
    descricao: "Eles vieram silenciosamente na escuridão, vindos do céu em busca de carne humana. Os parasitas - criaturas que assumem o controle de um hospedeiro humano para sobreviver - chegaram à Terra. Ninguém sabe disto exceto Shinichi Izumi, um estudante do ensino médio cuja mão direita foi infectada por um parasita. Shinichi, contra sua vontade, faz amizade com Migi, o parasita. Ambos se encontram agora no meio de uma guerra entre espécies.",
    temporadas: "1-Temporada",
    classificacao: "16",
    categoria: ["Drama", "Ficção Científica", "Ação", "Aventura", "Fantasia"],
